...
export class OrderService {
  ...
  // TODO: Roles
  getOrders(orderIds: string, perPage: number, currentPage: number, filter: string, start_date: Date, end_date: Date) {
  ...
  updateOrderStatus(status: string, id: string) {
    return this.http.put(BACKEND_URL_ORDER + "/updateStatus/" + id, { status, id })
  }
